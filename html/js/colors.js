...
( function (theProject) {
	...
	theProject.new({
		name:			"CSS Colors",
		description:	"all valid css colors",
		start: function (){
			theProject.show(list);
		}
	});
